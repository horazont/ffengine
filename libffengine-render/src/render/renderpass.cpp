                          ...
                          const RenderTarget &target)
{
    ...
    m_matrix_ubo.set<2>(m_viewpoint);
    m_matrix_ubo.set<3>(scenegraph.sun_colour());
    m_matrix_ubo.set<4>(scenegraph.sun_direction());
    m_matrix_ubo.set<5>(scenegraph.sky_diffuse().values);
